...
#define BOT_SIZE           58
#define BOT_SHOOT_DELAY    1.5f
#define BOT_ARMORED_SHOOT_DELAY 2.0f
#define BOT_TURN_DELAY     0.1f

#define BOT_SPEED_NORMAL   150.0f
#define BOT_SPEED_HOUND    200.0f
#define BOT_SPEED_HUNTER   150.0f
#define BOT_SPEED_ARMORED  110.0f
...
typedef union {
    struct { int hitCount; int armorIntegrity; } armored;
    struct { int rushingToBase; int ignorePlayer; } hound;
    struct { float lastSeenX, lastSeenY; } hunter;
} BotTypeData;
