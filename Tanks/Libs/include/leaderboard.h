...
// Обоснование: список позволяет вставлять новую запись в отсортированную
// позицию за O(n) без перекопирования, а также легко обрезать хвост
// сверх LEADERBOARD_MAX без сдвига элементов.
